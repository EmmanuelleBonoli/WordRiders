...
class _GameEndOverlayState extends State<GameEndOverlay>
  ...
  Widget build(BuildContext context) {
    ...
    // Titres
    final title = isWon
        ? context.tr('game.victory')
        : context.tr('game.defeat');
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            top: 16,
            left: 16,
            child: SafeArea(child: LifeIndicator()),
          ),

          Positioned(
            top: 16,
            right: 16,
            child: SafeArea(child: CoinIndicator(key: _coinIndicatorKey)),
          ),
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // BUTTONS
                                    isWon
                                        ? _buildVictoryButtons(context)
                                        : _buildDefeatButtons(context),
                                  ],
                                ),
                              ),
                            ),
          ...
          Stack(
            ...
            children: [
              PremiumRoundButton(
                ...
                onTap: () async {
                  ...
                  if (context.mounted) {
                    ResourceTransferAnimation.start(
                      ...
                      onComplete: () async {
                        final currentStage =
                            await PlayerPreferences.getCurrentStage();
                ...
                faceGradient: const [
                  AppTheme.btnPurpleTop,
                  AppTheme.btnPurpleBottom,
                ],
          ...
          Stack(
            ...
            children: [
              PremiumRoundButton(
                    ...
                    ResourceTransferAnimation.start(
                      ...
                      onComplete: () async {
                        final currentStage =
                            await PlayerPreferences.getCurrentStage();
                        final shouldShowAd =
                            await AdService.shouldShowAdForStage(currentStage);
                ...
                faceGradient: const [
                  AppTheme.btnGreenTop,
                  AppTheme.btnGreenBottom,
                ],
                iconGradient: const [AppTheme.white, AppTheme.white],
              ),
              Positioned(
        ...
        Stack(
          ...
          children: [
            PremiumRoundButton(
              ...
              faceGradient: const [
                AppTheme.coinFaceTop,
                AppTheme.coinFaceBottom,
              ],

...
class GameInputArea extends StatelessWidget {
  ...
  // Hauteur de la ligne de saisie et offset de la ligne dorée (milieu des
  // boutons Mélanger/Valider), exposés pour que `game_screen.dart` puisse y
  // caler le bas du fond de course (couche `down`).
  static const double inputRowHeight = 80.0;
  static const double goldenLineOffset = inputRowHeight / 2;

  @override
  Widget build(BuildContext context) {
    final inputRowHeight = GameInputArea.inputRowHeight;
    final halfRow = GameInputArea.goldenLineOffset;
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          top: halfRow,
          left:
              -50, // Marges de sécurité pour assurer une couverture totale en largeur
          right: -50,
